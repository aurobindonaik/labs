...
### Step2 -- `Install Java - Jenkins - Maven: follow instruction from link below`
   ...
   [INSTALL-JAVA-JENKINS-MAVEN](https://github.com/aurobindonaik/labs/blob/master/jenkins/Install-Java-Jenkins-ubuntu.txt)

### Step3 -- `Install Docker: follow instruction from link below`
    
   [INSTALL-DOCKER](https://github.com/aurobindonaik/labs/blob/master/docker/install/Install-Docker-manual.txt)

### Step4 -- `Install Ansible: follow instruction from link below`

   [INSTALL-ANSIBLE](https://github.com/aurobindonaik/labs/blob/master/ansible/install/InsallAnsible.txt)
...
> Copy the ssh-keys for ansible user from Jenkins machine (acting as ansible controller) to QA Swarm Manager & PROD Swarm Manager so that Jenkins can connect & deploy the containers. 
   ...
   [SSH-KEYS-SETUP](https://github.com/aurobindonaik/labs/blob/master/ansible/install/ssh-keys-setup.md)
...
```
   ...
   ( look at the sample inventory file under https://github.com/aurobindonaik/samplejavaapp/tree/master/deploy )
...
insdie job parameters as below 
	...
	Source Code Management --> Git --> Repository URL (https://github.com/aurobindonaik/samplejavaapp)
...
insdie job parameters as below 
	...
	Source Code Management --> Git --> Repository URL (https://github.com/aurobindonaik/samplejavaapp)  ## must give automation test suit repository
...
![CICD-PIC](https://github.com/aurobindonaik/labs/blob/master/cicd-flow/CICD-Picture.PNG)
